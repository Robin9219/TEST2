...
BOOL CSlideSet::OnInitDialog()
{
	...
	m_slidelist.InsertColumn(0, _T("序号"), LVCFMT_CENTER, rectCtrl.Width()*0.1, 0);
	m_slidelist.InsertColumn(1, _T("序号"), LVCFMT_CENTER, rectCtrl.Width()*0.1, 0);
	m_slidelist.InsertColumn(2, _T("选择玻片"), LVCFMT_CENTER, rectCtrl.Width()*0.15, 0);
	m_slidelist.InsertColumn(3, _T("玻片名称"), LVCFMT_CENTER, rectCtrl.Width()*0.20, 1);
	m_slidelist.InsertColumn(4, _T("模式"), LVCFMT_CENTER, rectCtrl.Width()*0.1, 2);
	m_slidelist.InsertColumn(5, _T("扫描范围（%）"), LVCFMT_CENTER, rectCtrl.Width()*0.25, 3);
	m_slidelist.InsertColumn(6, _T("备注"), LVCFMT_CENTER, rectCtrl.Width()*0.20, 4);
