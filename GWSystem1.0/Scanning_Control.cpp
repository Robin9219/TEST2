...
int Scanning_Control::Do_Scanning_Model()
{
	...
	while (states != Scanning_Finished)
	{
		...
		case X_Stepping_Finished:
			if (!Back_Right0)
			{
				Back_State1 = Do_Stepping_Finished(1, m_X_Moveto);
				if (Back_State1 == State_Finished)
					Back_Right0 = true;
				else
					Back_Right0 = false;
			}
			...
			if (!Back_Right2)
			{
				Back_State2 = Do_Stepping_Finished(3, m_Z_Moveto);
				if (Back_State2 == State_Finished)
					Back_Right2 = true;
				else
					Back_Right2 = false;
			}
			...
			else if ((Back_State1 == Stepping) || (Back_State2 == Stepping))
			{
				Back_State1 = State_Freeze;
				Back_State2 = State_Freeze;
				states = X_Stepping;
			}
		...
		case Y_Stepping_Finished:
			if (!Back_Right1)
			{
				Back_State1 = Do_Stepping_Finished(2, m_Y_Moveto);
				if (Back_State1 == State_Finished)
					Back_Right1 = true;
				else
					Back_Right1 = false;
